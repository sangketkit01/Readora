...
@section('content')
    ...
    <div class="container">
        ...
        <a class="btn" id="btn2" href="{{ url('user/rec2') }}" target="_self" role="button">commic</a>
        <div class="recommend-section1">
            <div class="recommend-card">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="https://images.unsplash.com/photo-1511988617509-a57c8a288659?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
